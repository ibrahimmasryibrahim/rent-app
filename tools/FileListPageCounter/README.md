...
## 4-هـ. اسم المستخدم أسفل الصفحات

- **اكتب اسمك** في المربع أعلى الجدول — مجرّد كتابته يُفعّل إظهاره تلقائيًا.
- يمكن إخفاؤه لاحقًا بإلغاء خيار «إظهاره في التقرير والطباعة» دون مسح الاسم.
- يظهر بحجم **9 نقاط** أسفل كل صفحة بصيغة «إعداد: الاسم».
- لا يظهر شيء إن تُرك الاسم فارغًا.
- لا يوجد في التقرير أي ذكر للمطوّر بأي صيغة — يوجد اختبار يفشل إن ظهرت أي كلمة من ذلك.

> **لا يحمل التقرير توقيع أي شخص.** التقرير مُولَّد من قائمة مجلد ولم «يُعدّه» أحد، لذلك لا
> يظهر اسم أي شخص في متنه ولا في تذييله ولا في خصائص الملف — حقل «الكاتب» في خصائص
> المستند يحمل اسم الأداة نفسها. اسم المطوّر يظهر في نافذة البرنامج وفي خصائص ملف الـ EXE فقط.
